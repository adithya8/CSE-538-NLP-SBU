...
if __name__ == '__main__':
    ...
    parser.add_argument('--model-type', type=str, help="Type of the advanced model", default='')
    ...
    config = {'vocab_size': vocab_size, 'embed_dim': args.embed_dim, 'training': True, 'hidden_size': args.hidden_size, 'model_type': args.model_type}
    ### TODO(Students END
